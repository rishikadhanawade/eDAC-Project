    ...
    render() {
        return (
            <section>
                ...
                <Route path="/Watches" render={() => <WatchCategory greet="Watches" exact />}></Route>
                ...
                <Route path="/Electronics" render={() => <ElectronicsCategory greet="Electronics" exact />}></Route>
                <Route path="/Customer/GetCustomer/:code" component={UserProfile} exact/>
                <Route path="/Profile" component={ProfilePage} exact/>
                <Route path="/Logout" component={Logout} exact/>
                {/* <Route path="/payment" component={Invoice} /> */}
                <Route path="/payment/:id" exact render={(props) => <Invoice {...props} key={props.match.params.id}/>}></Route>
