                    ...
                    props => (
                        ...
                        <div>
                            ...
                            <Form onSubmit={this.onUpdateCust}>
                                ...
                                <ErrorMessage component="div" name="cust_Address" className="error"></ErrorMessage><br />
                                ...
                                <ErrorMessage component="div" name="cust_PhoneNo" className="error"></ErrorMessage><br />
