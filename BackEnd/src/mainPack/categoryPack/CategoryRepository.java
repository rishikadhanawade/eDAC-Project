...
public interface CategoryRepository extends JpaRepository<Category,Integer> 
{
	...
	void deleteById(int cid);
        ...
        //Categories
	@Query("select "+ "new mainPack.categoryPack.DistinctCat(c.catmasterID, c.categoryName , c.catImagePath)"+" from Category c where c.categoryName not in('Sports','Watches')"+"group by c.categoryName")
